...
exports.ProgressBar = React.forwardRef(function (props, target) {
    ...
    var prevValue = usePrevious_1.usePrevious(value);
    ...
    var renderLabel = (labelVisible
        ...
        : undefined);
    var wrapperProps = {
        className: kendo_react_common_1.classNames('k-widget k-progressbar', {
    ...
    var positionClasses = kendo_react_common_1.classNames('k-progress-status-wrap', {
    ...
    var handleStart = React.useCallback(function () {
        var percentage = utils_1.calculatePercentage(min, max, prevValue);
        utils_1.updateProgress(progressStatusRef, progressStatusWrapRef, percentage, isVertical);
    }, [prevValue]);
    var handleUpdate = React.useCallback(function (progress) {
        var percentage = utils_1.calculatePercentage(min, max, prevValue + (value - prevValue) * progress);
        utils_1.updateProgress(progressStatusRef, progressStatusWrapRef, percentage, isVertical);
    }, [value, prevValue]);
    var handleEnd = React.useCallback(function () {
        var percentage = utils_1.calculatePercentage(min, max, value);
        utils_1.updateProgress(progressStatusRef, progressStatusWrapRef, percentage, isVertical);
    }, [value]);
