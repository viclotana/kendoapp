...
var DateTimePicker = /** @class */ (function (_super) {
    ...
    DateTimePicker.prototype.render = function () {
        ...
        return (React.createElement("div", { ref: function (div) {
                _this._element = div;
            }, className: rootClassName, onKeyDown: this.handleKeyDown, style: { width: width }, onFocus: this.handleFocus, onBlur: this.handleBlur },
            React.createElement("div", { ref: function (span) {
                    _this._wrapper = span;
                }, className: wrapperClassNames },
                this.props.dateInput ?
                    React.createElement(this.props.dateInput, __assign({}, dataInputProps)) :
                    React.createElement(DateInput_1.DateInput, __assign({ ref: function (dateInput) {
