...
var Tooltip = /** @class */ (function (_super) {
    ...
    function Tooltip(props) {
        ...
        _this.position = function (element) {
            ...
            var top = utils_1.getTopPosition(_this.top, domRect, element.offsetHeight, _this.props.anchorElement, _this.props.position);
    ...
    Tooltip.prototype.render = function () {
        ...
        return this.state.targetElement &&
            ...
            ReactDOM.createPortal((React.createElement("div", { ref: function (el) {
                ...
                }, className: kendo_react_common_1.classNames('k-animation-container', 'k-animation-container-fixed', 'k-animation-container-shown', this.props.className), style: this.props.style, tabIndex: 0 },
                React.createElement("div", { className: kendo_react_common_1.classNames('k-tooltip', this.props.tooltipClassName), style: __assign({ position: 'relative' }, this.props.tooltipStyle) },
