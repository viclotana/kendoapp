 ...
 * @hidden
 */
exports.GridSelectionCell = function (props) {
    ...
    var defaultRendering = props.rowType !== 'groupHeader' ? (React.createElement("td", __assign({ colSpan: props.colSpan, style: props.style, className: props.className }, navigationAttributes),
        React.createElement("input", { checked: data, id: inputId, type: "checkbox", className: "k-checkbox", onChange: handleOnChange }),
