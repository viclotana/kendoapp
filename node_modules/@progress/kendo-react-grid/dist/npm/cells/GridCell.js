...
exports.GridCell = function (props) {
    ...
    if (props.rowType === 'groupFooter') {
        ...
        defaultRendering = (React.createElement("td", __assign({ colSpan: props.colSpan, style: props.style, className: props.className, role: "gridcell", "aria-colindex": (props.columnIndex || 0) - (props.level || 0) + 1, "aria-selected": false }, navigationAttributes), dataAsString));
    }
    return props.render ?
